        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-[80%] max-w-sm bg-gradient-to-b from-[#18050d] via-[#0a0a0a] to-[#120a08] border-l border-gold-500/30 z-50 p-6 flex flex-col justify-between shadow-2xl md:hidden"
            >
              <div>
              ...
              <div className="pt-6 border-t border-gold-500/20 flex flex-col gap-3">
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-gold-500/40 bg-maroon-900/60 text-gold-300 text-xs font-semibold"
                >
